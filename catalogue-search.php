  ...
  <body>
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <a href="catalogue.php" class="navbar-brand"> <img src="images/logo.png" alt=""> </a>
            ...
            <ul class="navbar-nav">
              ...
              echo"<li class='nav-item'> <a href='catalogue.php' class='nav-link'>Free Streaming</a> </li>
      ...
      <div class="jumbotron"  style = "background-color: black">
        <h2 style='margin-top:0px;padding-top:0px; color:white'>Results : </h2>
            ...
            <?php
            include 'catalogue-searchback.php';
            ?>
