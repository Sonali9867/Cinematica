...
<head>
  <meta charset="utf-8">
  <title>Cinematica-Homepage</title>
...
<body>
  <header>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
      ...
      <ul class="navbar-nav">
        <li class="nav-item active"> <a href="catalogue.php" class="nav-link">Free Streaming</a> </li>
        <?php
      ...
      echo "<h1 style='color:welcome;position:sticky;'>WELCOME </h1><b style = 'color: white;font-size: 25px'><i> " . ucwords($rel['name']) . " !</i></b>
        </div>
        </header>
        <section>
      ...
      <input type='submit' name='submit' class='btn btn-success' style='display:inline;width:200px;margin-left:20px;margin-right:20px;' value='" . ucwords($rel2['name']) . "'/></h4>
        ...
        <div class='col'>
          <form action='catalogue-search.php' method='POST'>
    ...
    <div class="jumbotron" style = "background-color: black">
      <h2 style = "color:white">Free Movies</h2>

      <?php
      include 'catalogue-free-fetcher.php';
      ?>
    </div>

    <div class="jumbotron" style = "background-color:black">
      <h2 style = "color:white">Our catalogue</h2>

      <?php
      include 'catalogue-fetcher.php';
      ?>
    </div>
